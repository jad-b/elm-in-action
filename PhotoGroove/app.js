...
var $author$project$PhotoGroove$Damn = function (a) {
	return {$: 'Damn', a: a};
};
...
var $author$project$PhotoGroove$subscriptions = function (model) {
	var toMsg = function (res) {
		if (res.$ === 'Ok') {
			...
			return $author$project$PhotoGroove$Damn(
				$elm$json$Json$Decode$errorToString(decodeError));
		}
	};
	var msgDecoder = A2($elm$json$Json$Decode$map, $author$project$PhotoGroove$GotActivity, $elm$json$Json$Decode$string);
	var tryDecode = $elm$json$Json$Decode$decodeValue(msgDecoder);
	return $author$project$PhotoGroove$activityChanges(
